...
#undef LTTNG_TRACEPOINT_EVENT_MAP_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_MAP_MAY_FAULT(name, map, proto, args, fields) \
	LTTNG_TRACEPOINT_EVENT_CLASS_MAY_FAULT(map,			\
			     PARAMS(proto),				\
			     PARAMS(args),				\
			     PARAMS(fields))				\
	LTTNG_TRACEPOINT_EVENT_INSTANCE_MAP(map, name, map, PARAMS(proto), PARAMS(args))
...
#undef LTTNG_TRACEPOINT_EVENT_MAP_NOARGS_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_MAP_NOARGS_MAY_FAULT(name, map, fields)	\
	LTTNG_TRACEPOINT_EVENT_CLASS_NOARGS_MAY_FAULT(map,		\
			     PARAMS(fields))				\
	LTTNG_TRACEPOINT_EVENT_INSTANCE_MAP_NOARGS(map, name, map)
...
#undef LTTNG_TRACEPOINT_EVENT_CODE_MAP_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CODE_MAP_MAY_FAULT(name, map, proto, args, _locvar, _code_pre, fields, _code_post) \
	LTTNG_TRACEPOINT_EVENT_CLASS_CODE_MAY_FAULT(map,		\
			     PARAMS(proto),				\
			     PARAMS(args),				\
			     PARAMS(_locvar),				\
			     PARAMS(_code_pre),				\
...
#undef LTTNG_TRACEPOINT_EVENT_CODE_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CODE_MAY_FAULT(name, proto, args, _locvar, _code_pre, fields, _code_post) \
	LTTNG_TRACEPOINT_EVENT_CODE_MAP_MAY_FAULT(name, name,		\
			     PARAMS(proto),				\
			     PARAMS(args),				\
			     PARAMS(_locvar),				\
			     PARAMS(_code_pre),				\
...
#undef LTTNG_TRACEPOINT_EVENT_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_MAY_FAULT(name, proto, args, fields)	\
	LTTNG_TRACEPOINT_EVENT_MAP_MAY_FAULT(name, name,		\
			PARAMS(proto),					\
			PARAMS(args),					\
			PARAMS(fields))
...
#undef LTTNG_TRACEPOINT_EVENT_NOARGS_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_NOARGS_MAY_FAULT(name, fields)		\
	LTTNG_TRACEPOINT_EVENT_MAP_NOARGS_MAY_FAULT(name, name, PARAMS(fields))
...
#undef LTTNG_TRACEPOINT_EVENT_CLASS_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CLASS_MAY_FAULT(_name, _proto, _args, _fields) \
	LTTNG_TRACEPOINT_EVENT_CLASS_CODE_MAY_FAULT(_name, PARAMS(_proto), PARAMS(_args), , , \
		PARAMS(_fields), )
...
#undef LTTNG_TRACEPOINT_EVENT_CLASS_NOARGS_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CLASS_NOARGS_MAY_FAULT(_name, _fields) \
	LTTNG_TRACEPOINT_EVENT_CLASS_CODE_NOARGS_MAY_FAULT(_name, , , PARAMS(_fields), )
...
#undef LTTNG_TRACEPOINT_EVENT_CLASS_CODE_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CLASS_CODE_MAY_FAULT(_name, _proto, _args, _locvar, _code_pre, _fields, _code_post) \
...
#undef LTTNG_TRACEPOINT_EVENT_CLASS_CODE_NOARGS_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CLASS_CODE_NOARGS_MAY_FAULT(_name, _locvar, _code_pre, _fields, _code_post) \
...
#define _LTTNG_TRACEPOINT_EVENT_CLASS_CODE(_name, _data_proto, _locvar_args, _locvar, _code_pre, _fields, _code_post, _tp_flags) \
...
#define LTTNG_TRACEPOINT_EVENT_CLASS_CODE(_name, _proto, _args, _locvar, _code_pre, _fields, _code_post) \
	_LTTNG_TRACEPOINT_EVENT_CLASS_CODE(_name, PARAMS(void *__data, _proto), PARAMS(tp_locvar, _args), \
			PARAMS(_locvar), PARAMS(_code_pre), PARAMS(_fields), PARAMS(_code_post), 0)

#undef LTTNG_TRACEPOINT_EVENT_CLASS_CODE_NOARGS
#define LTTNG_TRACEPOINT_EVENT_CLASS_CODE_NOARGS(_name, _locvar, _code_pre, _fields, _code_post) \
	_LTTNG_TRACEPOINT_EVENT_CLASS_CODE(_name, PARAMS(void *__data), PARAMS(tp_locvar), PARAMS(_locvar), \
			PARAMS(_code_pre), PARAMS(_fields), PARAMS(_code_post), 0)

#undef LTTNG_TRACEPOINT_EVENT_CLASS_CODE_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CLASS_CODE_MAY_FAULT(_name, _proto, _args, _locvar, _code_pre, _fields, _code_post) \
	_LTTNG_TRACEPOINT_EVENT_CLASS_CODE(_name, PARAMS(void *__data, _proto), PARAMS(tp_locvar, _args), PARAMS(_locvar), \
			PARAMS(_code_pre), PARAMS(_fields), PARAMS(_code_post), TRACEPOINT_MAY_FAULT)

#undef LTTNG_TRACEPOINT_EVENT_CLASS_CODE_NOARGS_MAY_FAULT
#define LTTNG_TRACEPOINT_EVENT_CLASS_CODE_NOARGS_MAY_FAULT(_name, _locvar, _code_pre, _fields, _code_post) \
	_LTTNG_TRACEPOINT_EVENT_CLASS_CODE(_name, PARAMS(void *__data), PARAMS(tp_locvar), PARAMS(_locvar), PARAMS(_code_pre), \
			PARAMS(_fields), PARAMS(_code_post), TRACEPOINT_MAY_FAULT)
